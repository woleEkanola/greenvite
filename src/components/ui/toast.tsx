...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      'absolute right-2 top-2 rounded-md p-1 text-gray-500 opacity-0 transition-opacity hover:text-gray-900 focus:opacity-100 focus:outline-none focus:ring-2 group-hover:opacity-100 group-[.destructive]:text-gray-50 group-[.destructive]:hover:text-gray-50 group-[.destructive]:focus:ring-gray-400 group-[.destructive]:focus:ring-offset-gray-950 dark:text-gray-400 dark:hover:text-gray-50',
      className
    )}
    toast-close=""
    {...props}
